      subroutine zrunrc(n,rhs,sol,ipar,fpar,wk,guess,a,ja,ia,
     +     au,jau,ju,solver)
      implicit none
...
c
      ...
      ipar(1) = 0
c     time = dtime(dt)
 10   call zsolver(n,rhs,sol,ipar,fpar,wk)
c
...
c
      if (ipar(1).eq.1) then
         call zamux(n, wk(ipar(8)), wk(ipar(9)), a, ja, ia)
         goto 10
      else if (ipar(1).eq.2) then
         call zatmux(n, wk(ipar(8)), wk(ipar(9)), a, ja, ia)
         goto 10
      else if (ipar(1).eq.3 .or. ipar(1).eq.5) then
         call zlusol(n,wk(ipar(8)),wk(ipar(9)),au,jau,ju)
         goto 10
      else if (ipar(1).eq.4 .or. ipar(1).eq.6) then
         call zlutsol(n,wk(ipar(8)),wk(ipar(9)),au,jau,ju)
         goto 10
