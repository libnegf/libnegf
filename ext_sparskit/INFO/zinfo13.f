...
c---------- 
c 
c ao	= complex*16 array of length nnz used as work array.
...
c
	...
	if (valued) job = 1
	ipos = 1
        call zcsrcsc(n, job, ipos, a, ja, ia, ao, jao, iao)
        call zcsrcsc(n, job, ipos, ao, jao, iao, a, ja, ia)
c-------------------------------------------------------------------
...
c         call percentage_matrix(n,nnz,ja,ia,jao,80,jb1)
          ...
          call zbandpart(n,ja,ia,jao,80,jb1)
