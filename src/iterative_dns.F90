...
CONTAINS
  ...
  SUBROUTINE calls_eq_mem_dns(H,S,E,SelfEneR,Tlc,Tcl,gsurfR,Aout,struct,outer)
    ...
    !(omesso perchÃ¨ Ã¨ implementato un driver a parte)
  ...
  SUBROUTINE calls_neq_mem_dns(H,S,E,SelfEneR,Tlc,Tcl,gsurfR,struct,frm,min,Glout,out)
    ...
    !Chiamata di Make_gsml_mem solo se i contatti sono piÃ¹ di due o se il 
    !contatto a potenziale minimo Ã¨ nel primo blocco
